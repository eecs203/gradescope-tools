...
use anyhow::Result;
use futures::Stream;
use gradescope_api::assignment::{AssignmentClient, AssignmentId, AssignmentName};
use gradescope_api::course::CourseId;
...
impl UnmatchedReport {
    ...
    pub fn message(&self) -> String {
        let questions = if self.unmatched.questions().len() == 1 {
            // Singular
            "question"
        } else {
            // Plural
